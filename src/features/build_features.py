...
ax[1].plot(subset["acc_y_lowpass"].reset_index(drop=True), label="filtered")
...
# We can see that at point 3 the rate changes, we will choose 3 pca columns using the "Elbow technique"
